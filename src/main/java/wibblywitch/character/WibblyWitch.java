...
import wibblywitch.cards.common.PrepareDust;
import wibblywitch.cards.common.PrepareFireball;
import wibblywitch.cards.common.StaffSwipe;
import wibblywitch.cards.uncommon.DevilPact;
import wibblywitch.cards.uncommon.WyrdStrike;
...
public class WibblyWitch extends CustomPlayer {
    //Casting Mechanic
    ...
    //Strings
    private static final String ID = makeID("WibblyWitch"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass WIBBLYWITCH;
        @SpireEnum(name = "WIBBLYWITCH_GRAY_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "WIBBLYWITCH_GRAY_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public WibblyWitch() {
        super(NAMES[0], Enums.WIBBLYWITCH,
    ...
    public CharSelectInfo getLoadout() {
        WibblyWitchMod.logger.info(ORB_SLOTS);
    ...
    public AbstractPlayer newInstance() {
        ...
        return new WibblyWitch();
    }

    @Override
    public void increaseMaxOrbSlots(int amount, boolean playSfx) {
        // Not designed to have more than 2 orb slots.
        if (this.maxOrbs + amount <= 2) {
            super.increaseMaxOrbSlots(amount, playSfx);
        }
    }

    public void quicken(int amount) {
        if (this.hasOrb()) {
            AbstractOrb o = this.orbs.get(0);
            if (o.passiveAmount - amount < 0) {
                evokeOrb();
            } else {

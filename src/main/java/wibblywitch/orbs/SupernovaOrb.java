...
public class SupernovaOrb extends AbstractSpellOrb {

    public static final String ID = makeID("SupernovaOrb");
    ...
    private final static int BASE_DELAY = 4;
    public final static int BASE_DAMAGE = 32;
    private int damage;

    public SupernovaOrb(AbstractMonster m) {
        super(BASE_DELAY);
    ...
    @Override
    public void onEvoke() {
        AbstractDungeon.actionManager.addToTop(new SupernovaEvokeAction(m, this.damage));
    }

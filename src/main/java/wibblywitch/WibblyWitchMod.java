...
@SpireInitializer
public class WibblyWitchMod implements
        EditCardsSubscriber,
    ...
    private static final String resourcesFolder = "wibblywitch";
    ...
    private static final Color cardColor = new Color(2/5f, 1/5f, 3/5f, 1f);
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(WibblyWitch.Enums.CARD_COLOR, cardColor,
                BG_ATTACK, BG_SKILL, BG_POWER, ENERGY_ORB,
                BG_ATTACK_P, BG_SKILL_P, BG_POWER_P, ENERGY_ORB_P,
                SMALL_ORB);
    }

    public WibblyWitchMod() {
        BaseMod.subscribe(this); //This will make BaseMod trigger all the subscribers at their appropriate times.
        logger.info(modID + " subscribed tococ BaseMod.");
    }
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new WibblyWitch(),
                CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, WibblyWitch.Enums.WIBBLYWITCH);
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(WibblyWitchMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
